			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>N0 CUENTA:</strong> '.$rows['producto_codigo'].', <strong>CEDULA:</strong> '.$rows['producto_precio'].', <strong>CELULAR:</strong> '.$rows['producto_stock'].', <strong>CATEGORIA:</strong> '.$rows['categoria_nombre'].', <strong>REGISTRADO POR:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
